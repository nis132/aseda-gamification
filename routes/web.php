...
Route::match(['POST', 'GET'], '/tantangan/{tantangan}/submit', [SiswaController::class, 'submit'])->name('tantangan.submit');        Route::get('/leaderboard', [SiswaController::class, 'leaderboard'])->name('leaderboard');
