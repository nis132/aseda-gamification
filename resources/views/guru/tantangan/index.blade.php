            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-info me-1">{{ $t->mapel->nama_mapel }}</span>
                            <span class="badge bg-secondary">{{ $t->kelas->nama_kelas }}</span>
                        </td>
                        <td>
                            <span class="badge bg-{{ $t->tipe == 'pg' ? 'primary' : ($t->tipe == 'essay' ? 'warning' : 'success') }} fs-6 px-3">
                                {{ strtoupper($t->tipe) }}
                            </span>
                        </td>
                        <td><strong class="text-success">{{ $t->poin }} Poin</strong></td>
                        <td>
                        ...
                        <td class="text-center">
                            <div class="btn-group btn-group-sm">
                                ...
                                <form action="{{ route('guru.tantangan.destroy', $t) }}" method="POST" class="d-inline">
                                    @csrf @method('DELETE')
                                    <button class="btn btn-outline-danger" onclick="return confirm('Yakin?')">
                    ...
                    <tr>
                        <td colspan="6" class="text-center py-5">
                            ...
                            <a href="{{ route('guru.tantangan.create') }}" class="btn btn-primary">Buat Sekarang</a>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
